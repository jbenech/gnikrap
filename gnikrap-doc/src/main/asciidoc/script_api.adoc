...
[[img-ev3-motors]]
.45502 Large Servo Motor / 45503 Medium Servo Motor - image from http://education.lego.com
...
isn't started (i.e. `isStarted` returns `false`), all the other methods on the value object will not be available: If you try to call
